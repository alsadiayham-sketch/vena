...
var cart = normalizeCartItems(JSON.parse(localStorage.getItem('vena_cart') || '[]'), normalizeProducts(DEFAULT_PRODUCTS));
var deliveryMethod = localStorage.getItem('vena_delivery_method') || 'delivery';
...
function saveCart() {
    localStorage.setItem('vena_cart', JSON.stringify(normalizeCartItems(cart, products.length ? products : normalizeProducts(DEFAULT_PRODUCTS))));
}

function setDeliveryMethod(method) {
    deliveryMethod = method;
    localStorage.setItem('vena_delivery_method', method);
